...
class TrailerRequest extends FormRequest
{
    ...
    {
        return [
          'trailer_id_number' => 'required|max:15',
    ...
    {
        return [
          'trailer_id_number.required' => 'Numer rejestracyjny jest wymagany.',
          'trailer_id_number.max' => 'Numer rejestracyjny ma maksymalnie 15 znaków.',
