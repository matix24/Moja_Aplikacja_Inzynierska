      ...
      <div class="row">
          <div class="col-md-8 col-md-offset-2">
              <div class="panel panel-default">
                <div class="panel-heading">Dodawanie administratora</div>
                  <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('InstallUser') }}">
                        {{ csrf_field() }}

                        <h3>
                          Utwórz pracownika aplikacji
                          <i class="fa fa-question-circle" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="Utworzenie pracownika pozwoli na piersze zalogowanie w aplikacji."></i>
                        </h3>
                        <br />
                        {{-- name --}}
