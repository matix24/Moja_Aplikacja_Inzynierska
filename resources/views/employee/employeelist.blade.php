          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <p>Czy aby na pewno chcesz archiwizować tego pracownika?</p>
                  </div>
            ...
            <td>
              @if ( Auth::user()->ID_roles == 1 )
                  <span style="float:left; margin-right:3px;">
                    {{ Form::open(['method' => 'get', 'route' => [ 'employee.edit', $user->id ]]) }}
                    {{ Form::button('<i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edytuj', ['type' => 'submit', 'class' => 'btn btn-info btn-xs'] )  }}
                    {{ Form::close() }}</span>

                    {!! Form::model($user, ['method' => 'post', 'route' => ['EmployeeToArchive', $user->id], 'class' =>'form-inline form-delete']) !!}
