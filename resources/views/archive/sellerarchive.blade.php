...
@section('content')
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Archiwum sprzedawców</li>
    </ol>
  </div>
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <p>Czy aby na pewno chcesz usunąć tego sprzedawcę?</p>
                  </div>
              ...
              @if ( Auth::user()->ID_roles == 1 )
                <td>
                  <span style="float:left; margin-right:3px;">
                    {{ Form::open(['method' => 'post', 'route' => [ 'SellerFromArchive', $seller->id ]]) }}
                    {{ Form::button('<i class="fa fa-edit"></i> Przywróć', ['type' => 'submit', 'class' => 'btn btn-info btn-xs'] )  }}
                    {{ Form::close() }}</span>

                    {!! Form::model($seller, ['method' => 'delete', 'route' => ['seller.destroy', $seller->id], 'class' =>'form-inline form-delete']) !!}
