...
@section('content')
  <div class="row">
    <ol class="breadcrumb">
      ...
      <li class="active">Archiwum przyczep</li>
    </ol>
  </div>
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <p>Czy aby na pewno chcesz usunąć tą przyczepę?</p>
                  </div>
            ...
            @if (Auth::user()->ID_roles == 1)
              <td>
                <span style="float:left; margin-right:3px;">
                  {{ Form::open(['method' => 'post', 'route' => [ 'TrailerFromArchive', $trailer->id ]]) }}
                  {{ Form::button('<i class="fa fa-edit"></i> Przywróć', ['type' => 'submit', 'class' => 'btn btn-info btn-xs'] )  }}
                  {{ Form::close() }}</span>

                  {!! Form::model($trailer, ['method' => 'delete', 'route' => ['trailer.destroy', $trailer->id], 'class' =>'form-inline form-delete']) !!}
