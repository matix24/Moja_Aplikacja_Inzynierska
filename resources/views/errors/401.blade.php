          ...
          <div class="col-md-12">
              <div class="error-template">
                  ...
                  <div class="error-details">
                      Ten serwer nie mógł sprawdzić, czy użytkownik jest uprawniony do uzyskania dostępu do żądanego dokumentu. Albo dostarczył błędne dane uwierzytelniające (np złe hasło), lub Twoja przeglądarka nie rozumie, jak dostarczyć wymagane poświadczenia. !
                  </div>
