        ...
        <div class="container-fluid">
          <div class="row">
            <ol class="breadcrumb">
              ...
              <li class="active">Edytuj przyczepę</li>
            </ol>
          </div>
            <div class="row" id="main" >
            <div class="panel panel-default">
                <div class="panel-heading"><b>Edycja przyczepy</b></div>
                <div class="panel-body">
                  {{-- <form class="form-horizontal" role="form" method="POST" action="{{ route('employee.update') }}"> --}}
                      {{ csrf_field() }}
                      {!! Form::model($trailer, ['method' => 'PATCH', 'class' => 'form-horizontal', 'action' => ['TrailerController@update', $trailer->id] ]) !!}
                      ...
                      <div class="form-group{{ $errors->has('trailer_id_number') ? ' has-error' : '' }}">
                          ...
                          <div class="col-md-6">
                              ...
                              {!! Form::text('trailer_id_number', null, ['class' => 'form-control']) !!}
