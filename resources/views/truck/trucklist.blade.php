          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <p>Czy aby na pewno chcesz archiwizować ten samochód?</p>
                  </div>
            ...
            @if (Auth::user()->ID_roles == 1)
              <td>
                <span style="float:left; margin-right:3px;">
                  {{ Form::open(['method' => 'get', 'route' => [ 'truck.edit', $truck->id ]]) }}
                  {{ Form::button('<i class="fa fa-edit"></i> Edytuj', ['type' => 'submit', 'class' => 'btn btn-info btn-xs'] )  }}
                  {{ Form::close() }}</span>

                  {!! Form::model($truck, ['method' => 'post', 'route' => ['TruckToArchive', $truck->id], 'class' =>'form-inline form-delete']) !!}
